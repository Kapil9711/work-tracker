const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DropDown-eh70JgbL.js","assets/index-iTZG_CXf.js","assets/index-PGTi1PBy.css","assets/Modal-KtViZ_xK.js","assets/DashboardPage-DyKd9pmP.js","assets/styled-components.browser.esm-DYxTFAtm.js","assets/Toasts-wLaCnDvT.js","assets/Toasts-BTGsrsBX.css"])))=>i.map(i=>d[i]);
import{r as o,j as e,_ as x,a as h,s as c}from"./index-iTZG_CXf.js";import{d as l}from"./styled-components.browser.esm-DYxTFAtm.js";import{ThemeContext as d}from"./DashboardPage-DyKd9pmP.js";const m=l.button`
...
`,a=({children:t,active:n,setActive:r})=>{const{theme:s}=o.useContext(d);return e.jsx(m,{onClick:()=>r(t),compare:t,active:n,theme:s,className:"rounded-full py-[10px] px-[24px] font-bold tracking-wide text-center",children:t})},g=o.lazy(()=>x(()=>import("./DropDown-eh70JgbL.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]))),p=l.nav`
